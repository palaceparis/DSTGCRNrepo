...
def get_dataloader(args, normalizer="std", single=True):
    ...
    if args.save_arrays_EDA:
        np.save("data/processed/AGCRN_dynamic/data_train.npy", data_train)
        np.save("data/processed/AGCRN_dynamic/data_val.npy", data_val)
        np.save("data/AGCRN_dynamic/data_test.npy", data_test)
